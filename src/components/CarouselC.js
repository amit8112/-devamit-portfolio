      ...
      >
        <div>
          <div className="service-item">
            ...
            <h4>UI/UX Design/ Wordpress</h4>
            <p>
              2 year freelancing experience on wordpress development Create
              visually stunning and intuitive UI/UX designs tailored to your
              target audience
            </p>
          </div>
        </div>
        ...
        <div>
          <div className="service-item">
            ...
            <p>
              Developing web apps MERN Stack , using the latest technologies and
              frameworks to create fast, responsive, and intuitive apps
            </p>
          </div>
        </div>
      </Carousel>
